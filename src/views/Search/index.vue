    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <Pagination :total="total" :pageSize="searchParams.pageSize" :pageNo="searchParams.pageNo" :continues="5" @getPageNo="getPageNo"></Pagination>
        </div>
      </div>
    </div>
  </div>
...
import { mapGetters,mapState } from "vuex";
  ...
  export default {
    ...
    // changeOrder(flag){
    //   let orginFlag = this.searchParams.order.spilt(":")[0];
    //   let originSort = this.searchParams.order.spilt(":")[1];
    //   let newOrder = '';
    //   if(flag==originFlag){
